 ...
 */
abstract class BaseSentFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'send_date'  => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'send_date'  => new sfValidatorPass(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('sent_filters[%s]');
