...
/**
 * ProgramData filter form base class.
 *
 * @package    sms
 * @subpackage filter
 ...
 */
abstract class BaseProgramDataFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('program_data_filters[%s]');
