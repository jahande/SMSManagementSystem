...
/**
 * ElectionData form base class.
 *
 * @method ElectionData getObject() Returns the current form's model object
 *
 * @package    sms
 * @subpackage form
 ...
 */
abstract class BaseElectionDataForm extends ProgramDataForm
{
  protected function setupInheritance()
  {
    ...
    $this->widgetSchema->setNameFormat('election_data[%s]');
  }
